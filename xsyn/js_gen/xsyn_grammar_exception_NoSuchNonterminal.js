/*
 * Generated code for class xsyn.grammar.exception.NoSuchNonterminal
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var NoSuchNonterminal = function(thing) {
  this.thing = thing;
};
util.inherits(NoSuchNonterminal,xsyn.grammar.exception.SyntaxError);

NoSuchNonterminal.prototype.__defineGetter__('thing', function() {
  return this.$thing$;
});
NoSuchNonterminal.prototype.__defineSetter__('thing', function(thing) {
  this.$thing$ = thing;
});
 ...
 */
NoSuchNonterminal.prototype.getMessage = function() {
  'nonterminal not found in grammar: ' + this.thing;
}


module.exports = NoSuchNonterminal
