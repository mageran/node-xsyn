/*
 * Generated code for class xsyn.grammar.impl.lalr1.AcceptAction
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var AcceptAction = function(token) {
  xsyn.grammar.impl.lalr1.ReduceAction.call(this, token);
};
util.inherits(AcceptAction,xsyn.grammar.impl.lalr1.ReduceAction);

/**
 * @method toString()
 * @returns java.lang.String
 */
AcceptAction.prototype.toString = function() {
  var s = '';
  s += 'accept';
 ...
 * @returns void
 */
AcceptAction.prototype.apply = function(state) {
 ...
 * @returns void
 */
AcceptAction.prototype.undo = function(state) {
