/*
 * Generated code for class xsyn.grammar.exception.SyntaxError
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var SyntaxError = function(pstate) {
  var token = pstate.getTokenForErrorReporting();
  var msg = '';
  msg += 'syntax error at ' + token.getStartPosition() + ': ';
  if (token.getId() === DefaultTokenStream.TOKEN_EOF) {
...
SyntaxError.prototype.__defineGetter__('errorMessage', function() {
  return this.$errorMessage$;
});
SyntaxError.prototype.__defineSetter__('errorMessage', function(errorMessage) {
