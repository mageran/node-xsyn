/*
 * Generated code for class xsyn.grammar.impl.Position
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var Position = function(currentStartLine,currentStartColumn) {
  this.currentStartLine = currentStartLine;
  this.currentStartColumn = currentStartColumn;
};

Position.prototype.__defineGetter__('currentStartLine', function() {
  return this.$currentStartLine$;
});
Position.prototype.__defineSetter__('currentStartLine', function(currentStartLine) {
  this.$currentStartLine$ = currentStartLine;
});

Position.prototype.__defineGetter__('currentStartColumn', function() {
  return this.$currentStartColumn$;
});
Position.prototype.__defineSetter__('currentStartColumn', function(currentStartColumn) {
  this.$currentStartColumn$ = currentStartColumn;
});
