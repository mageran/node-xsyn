/*
 * Generated code for class xsyn.grammar.impl.lalr1.ShiftAction
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var ShiftAction = function(token,itemSet) {
  xsyn.grammar.impl.lalr1.TokenParseAction.call(this, token,itemSet);
  TokenParseAction.call(this,token);
  this.itemSet = itemSet;
};
util.inherits(ShiftAction,xsyn.grammar.impl.lalr1.TokenParseAction);

ShiftAction.prototype.__defineGetter__('itemSet', function() {
  return this.$itemSet$;
});
ShiftAction.prototype.__defineSetter__('itemSet', function(itemSet) {
  this.$itemSet$ = itemSet;
});
 ...
 */
ShiftAction.prototype.toString = function() {
  return 'shift(' + this.itemSet.name + ')';
}
 ...
 * @returns void
 */
ShiftAction.prototype.apply = function(state) {
  state.pushParseState(this.itemSet);
  state.pushCurrentToken();
  state.shiftToken();
}
 ...
 * @returns void
 */
ShiftAction.prototype.undo = function(state) {
  state.unshiftToken();
  state.popTokenStack();
  state.popParseState();
}
