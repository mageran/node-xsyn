/*
 * Generated code for class xsyn.grammar.exception.IllegalNonterminalName
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var IllegalNonterminalName = function(illegalNonterminalName) {
  this.illegalNonterminalName = illegalNonterminalName;
};
util.inherits(IllegalNonterminalName,xsyn.grammar.exception.SyntaxError);

IllegalNonterminalName.prototype.__defineGetter__('illegalNonterminalName', function() {
  return this.$illegalNonterminalName$;
});
IllegalNonterminalName.prototype.__defineSetter__('illegalNonterminalName', function(illegalNonterminalName) {
  this.$illegalNonterminalName$ = illegalNonterminalName;
});
 ...
 */
IllegalNonterminalName.prototype.getMessage = function() {
  return 'illegal nonterminal name: "' + this.illegalNonterminalName + '"';
}


module.exports = IllegalNonterminalName
