/*
 * Generated code for class xsyn.grammar.impl.lalr1.TokenParseAction
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var TokenParseAction = function(token) {
  this.token = token
};

TokenParseAction.prototype.__defineGetter__('token', function() {
  return this.$token$;
});
TokenParseAction.prototype.__defineSetter__('token', function(token) {
  this.$token$ = token;
});


module.exports = TokenParseAction
