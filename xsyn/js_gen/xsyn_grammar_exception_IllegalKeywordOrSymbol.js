/*
 * Generated code for class xsyn.grammar.exception.IllegalKeywordOrSymbol
 *
 * ***** DO NOT MODIFY *****
 *
 */
...
var IllegalKeywordOrSymbol = function(illegalKeywordOrSymbol) {
  this.illegalKeywordOrSymbol = illegalKeywordOrSymbol;
};
util.inherits(IllegalKeywordOrSymbol,xsyn.grammar.exception.SyntaxError);

IllegalKeywordOrSymbol.prototype.__defineGetter__('illegalKeywordOrSymbol', function() {
  return this.$illegalKeywordOrSymbol$;
});
IllegalKeywordOrSymbol.prototype.__defineSetter__('illegalKeywordOrSymbol', function(illegalKeywordOrSymbol) {
  this.$illegalKeywordOrSymbol$ = illegalKeywordOrSymbol;
});
 ...
 */
IllegalKeywordOrSymbol.prototype.getMessage = function() {
  return 'illegal keyword/symbol in grammar: "' + this.illegalKeywordOrSymbol + '"';
}


module.exports = IllegalKeywordOrSymbol
